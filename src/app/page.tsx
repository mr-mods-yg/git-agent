...
const PROVIDERS = [
  ...
  { id: 'google', name: 'Google Gemini', defaultModel: 'gemini-3-flash' },
];
        ...
        <MessageScrollerProvider autoScroll>
          <MessageScroller className="flex-1">
            <MessageScrollerViewport className="px-4 py-6 md:px-8">
              <MessageScrollerContent aria-busy={status !== 'ready'}>
                {messages.length === 0 ? (
                  <MessageScrollerItem messageId="empty-state">
                    ...
                    <div className="max-w-2xl mx-auto h-full flex flex-col justify-center items-center py-12 px-4 space-y-8">
                      ...
                      <div className="text-center space-y-2">
                        <p className="text-sm font-semibold text-neutral-200 tracking-tight">Ask Git Agent</p>
                        <p className="text-xs text-neutral-500 max-w-xs leading-relaxed">
                          Explore repositories, analyze issues, review pull requests, and more.
                        </p>
                      </div>
                  ...
                  <div className="max-w-2xl mx-auto space-y-6 w-full">
                            ...
                            <div className="flex gap-4 items-start">
                              ...
                              <div className="flex-1 space-y-3 overflow-hidden text-[13.5px] text-neutral-200 leading-relaxed pt-0.5">
                                ...
                                {status !== 'ready' && isLastMessage && (
                                  <div className="flex items-center gap-1.5 py-1 px-1 mt-2">
                    ...
                    {/* Loader when no assistant message yet */}
                    {status !== 'ready' && !lastMessageIsAssistant && (
          ...
          <div className="max-w-2xl mx-auto relative">
            <form onSubmit={handleSubmit} className="relative">
              ...
              <button
                ...
                className={`absolute right-2 bottom-2 w-8 h-8 flex items-center justify-center rounded-xl border transition-all duration-150 ${
...
function ToolInvocation({ part }: { part: any }) {
  ...
  return (
    <div className="rounded-xl border border-neutral-800/80 bg-[#121214]/60 overflow-hidden backdrop-blur-sm shadow-sm max-w-xl">
      <div
